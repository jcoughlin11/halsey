...
Notes:
    ...
    4.) For losses requiring extra args (in addition to y_true and
        ...
        It appears that variables passed to the wrapper are passed by
        value, which means they don't change from the initial value
        passed to the function at compilation time.
